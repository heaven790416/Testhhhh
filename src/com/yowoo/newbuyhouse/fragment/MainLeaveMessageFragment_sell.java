...
public class MainLeaveMessageFragment_sell extends MyFragment{
	...
	EditText nameEditText, phoneEditText, emailEditText, demandEditText, 
			 laneEditText, alleyEditText, noEditText, floorEditText;
	...
	public static Fragment newInstance(Context context) {
		MainLeaveMessageFragment_sell f = new MainLeaveMessageFragment_sell();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_main_leave_message_sell, null);
        ...
        //set views
        		demandEditText = (EditText) root.findViewById(R.id.OtherDemandEditText);
	      		...
	      		laneEditText = (EditText) root.findViewById(R.id.laneEditText);
	      		alleyEditText = (EditText) root.findViewById(R.id.alleyEditText);
	      		noEditText = (EditText) root.findViewById(R.id.noEditText);
	      		floorEditText = (EditText) root.findViewById(R.id.floorEditText);
    ...
    private void reloadRoad(String zipcode){
		...
		Log.e("test", "ArrayList<String> road = LeaveMessageService.getRoad(zipcode); "+road);
    ...
    private void setListener(){
    	...
    	sendButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String lane = laneEditText.getText().toString();
				String alley = alleyEditText.getText().toString();
...
//				}
				...
				params.put(BHConstants.PARAM_MESSAGE_TYPE, "7");
				...
				params.put("dataCity", cityName);
				params.put("dataCounty", areaName);
				params.put("dataRoad", roadName);
				params.put("desc", demand);
				
				params.put("detailAlley", lane); //巷
				params.put("detailLane", alley);  //弄
				params.put("detailNum", no);
				params.put("detailFloor", floor);
				
				Log.e("test", lane+alley+no+floor);
