...
public class RoadWheelView extends RelativeLayout{
	...
	public RoadWheelView(Context context) {
		super(context);
		init(context);
	}

	public RoadWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	...
	public RoadWheelView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void initWheels(String[] chooseItems, int selectedIndex){
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				RoadWheelView.this.setVisibility(View.GONE);
