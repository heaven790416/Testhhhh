...
//        post(mTabSelector);
    ...
    private void addTab(int index, CharSequence text, int iconResId) {
    	final TabImageView tabImageView = new TabImageView(getContext());
    	tabImageView.mIndex = index;
    	tabImageView.setFocusable(true);
    	tabImageView.setOnClickListener(mTabClickListener);
    	
    	tabImageView.setImageResource(iconResId);
    	
    	// this TabView is text view, so his implementation is to use textview plus the left icon defined in the text view methods to do this. 
...
//        }
        ...
        mTabLayout.addView(tabImageView, new LinearLayout.LayoutParams(0, MATCH_PARENT, 1));
    }
